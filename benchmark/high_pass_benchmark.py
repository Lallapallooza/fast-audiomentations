...
class AudiomentationsBenchmarkSuite(BenchmarkSuite):
    ...
    def on_start(self):
        ...
        self.high_pass_filter = HighPassFilter(min_cutoff_freq=100, max_cutoff_freq=10000, p=1.0)
...
class FastAudiomentationsBenchmarkSuite(BenchmarkSuite):
    ...
    def run_iteration(self):
        r = self.high_pass_filter(samples=self.audio, sample_rate=44100)
...
if __name__ == '__main__':
    benchmark = Benchmark(name="High Pass Filter Benchmark", bench_type="high_pass_filter")
    benchmark.run()
