...
class AudiomentationsBenchmarkSuite(BenchmarkSuite):
    ...
    def on_start(self):
        ...
        self.band_pass_filter = BandPassFilter(min_center_freq=100, max_center_freq=10000, p=1.0)
...
class TorchAudiomentationsBenchmarkSuite(BenchmarkSuite):
    ...
    def on_start(self):
        ...
        self.band_pass_filter = BandPassFilter(min_center_frequency=100, max_center_frequency=10000, p=1.0)
...
if __name__ == '__main__':
    benchmark = Benchmark(name="Band Pass Filter Benchmark", bench_type='band_pass_filter')
    benchmark.run()
