from fast_audiomentations.transforms._impl._filter_triton import create_filters as _create_high_pass_filters
...
class HighPassFilter:
    """
    Class for applying a high-pass filter to audio samples.

    Attributes:
        min_cutoff_freq (int): Minimum cutoff frequency for the high-pass filter.
        max_cutoff_freq (int): Maximum cutoff frequency for the high-pass filter.
    ...
    def __generate_random_cutoffs(self, num_audios):
        """
        Generate random cutoff frequencies for the high-pass filter.
    ...
    def __call__(self, samples: torch.Tensor, sample_rate: int, inplace=False):
        """
        Apply the high-pass filter to the audio samples.

        @param samples: Input audio samples tensor.
        @param sample_rate: Sample rate of the audio.
        @param inplace: If True, perform the operation in-place.
        @return: Audio samples after applying the high-pass filter.
        """
